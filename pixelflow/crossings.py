...
class Crossings:
    ...
    This class provides centralized management of multiple crossings,
    allowing for easy processing of detections against all crossings at once.
    """
    
    def __init__(self):
        """Initialize the Crossings manager."""
    ...
    def update(self, results, strategy: Union[str, List[str]] = None):
        ...
        This method checks each detection against all crossings and updates:
        - prediction.line_crossings: List of crossing events for each detection
        - Crossing statistics (in_count, out_count, per-class counts)
    ...
    def get_crossing_counts(self) -> Dict[Union[int, str], Dict[str, int]]:
        """
        Get current counts for all crossings.
    ...
    def reset_all_counts(self):
        """Reset counts for all crossings."""
        for crossing in self.crossings:
